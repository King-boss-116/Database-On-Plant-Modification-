...
class UpdateFunction implements ActionListener{
	...
	public UpdateFunction(){
		...
		f1.setTitle("Updating Employee Name As Admin");
		
		l2=new JLabel("Write the Microbe Id");
		t2=new JTextField(); 
		l1=new JLabel("Write the New Updated Value for Microbe Application");
		t1=new JTextField();
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==b1)
		{
			...
			try{
				...
				String qry="update microbes set Microbe_Functions=? where Microbe_Id=?";
...
class UpdateFunctionMain{

	public static void main(String arg[]){
	
		UpdateFunction p16=new UpdateFunction();
