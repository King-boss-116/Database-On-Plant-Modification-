...
class UpdateOrigin implements ActionListener{
	...
	public UpdateOrigin(){
		...
		t2=new JTextField(); 
		l1=new JLabel("Write the New Updated Value for Microbe Origin");
		t1=new JTextField();
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==b1)
		{
			...
			try{
				...
				String qry="update microbes set Microbe_Occurance=? where Microbe_Id=?";
...
class UpdateOriginMain{

	public static void main(String arg[]){
	
		UpdateOrigin p16=new UpdateOrigin();
